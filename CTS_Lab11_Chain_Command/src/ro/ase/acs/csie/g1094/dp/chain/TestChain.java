...
public class TestChain {
	...
	public static void main(String[] args) {
		...
		chatServer.processMessage(new Message("@everyone","Kill Superman. It's a bot.",0));
		chatServer.processMessage(new Message("@John","Let's start level 2",1));
		chatServer.processMessage(new Message("@everyone","Let's join the party!",2));
